...
class demo_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, header_00=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/sdr/Documents/GRHackRF/bits_recieved', False)
        ...
        self.connect((self.blocks_repack_bits_bb_1, 0), (self.blocks_repack_bits_bb_1_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_0_0, 0), (self.blocks_file_sink_0_0, 0))
        self.connect((self.blocks_repack_bits_bb_1_0_0, 0), (self.blocks_file_sink_1, 0))
